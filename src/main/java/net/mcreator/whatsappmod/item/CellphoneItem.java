...
import net.mcreator.whatsappmod.gui.CellphoneGUIGui;
...
public class CellphoneItem extends WhatsappmodModElements.ModElement {
	@ObjectHolder("whatsappmod:cellphone")
	public static final Item block = null;
	public CellphoneItem(WhatsappmodModElements instance) {
		super(instance, 20);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof CellphoneGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(WhatsAppModItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON));
			setRegistryName("cellphone");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Cellphone");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CellphoneGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
