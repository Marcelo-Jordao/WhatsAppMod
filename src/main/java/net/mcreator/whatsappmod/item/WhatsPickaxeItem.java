...
public class WhatsPickaxeItem extends WhatsappmodModElements.ModElement {
	@ObjectHolder("whatsappmod:whats_pickaxe")
	public static final Item block = null;
	public WhatsPickaxeItem(WhatsappmodModElements instance) {
		super(instance, 5);
	}
